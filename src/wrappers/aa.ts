...
import { AaRankApi } from "../api/aa-rank-api";
import { SpireQueryBuilder } from "../spire-query-builder";
import { AaAbilityApi } from "../api/aa-ability-api";
import { DbStrApi } from "../api/db-str-api";
...
export class AA {
  ...
  static async getAARankById(rankId) {
    let builder = new SpireQueryBuilder();
    builder.includes(["AaAbility", "SpellsNew"]);
