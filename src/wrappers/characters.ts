import { CharacterDatumApi } from "../api/character-datum-api";
...
export class Characters {
  ...
  static async get(id) {
    ...
    const r = await new CharacterDatumApi(...SpireApi.cfg()).getCharacterDatum({
      id: id,
    });
  ...
  static async bulkLoadCharacters(ids: any[]) {
    ...
    const r = await new CharacterDatumApi(
      ...SpireApi.cfg()
